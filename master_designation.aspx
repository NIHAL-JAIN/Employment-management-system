<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="master_designation.aspx.cs" Inherits="EventManager.master_designation" %>
            ...
            <tr>
                <td colspan="3">
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td width="45%">
                                <asp:DropDownList ID="DropDownList1" runat="server" class="form-control" Height="38px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="603px">
